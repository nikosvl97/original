            ...
            <div class="px-3 pt-3">
                        ...
                        <div class="d-flex align-items-center">
                            @if(isset($subLocked) && $stream->user->id !== Auth::user()->id)
                                ...
                                <span class="p-pill ml-2 pointer-cursor to-tooltip stream-subscribe-button"
                                      ...
                                      data-amount="{{$stream->user->profile_access_price ? $stream->user->profile_access_price : 0}}"
                ...
                <div class="stream-chat mb-4 {{$stream->canWatchStream ? '' : 'mt-3'}}">
                    ...
                    <div class="card pb-3" >
                        ...
                        @else
                            <div class="d-flex align-items-center justify-content-center mt-4 stream-chat-no-message"><span>🔒 Chat locked. Unlock the stream to see the messages.</span></div>
                        @endif
                    </div>
                </div>
            </div>
